...
def get_web_info(book_id, start_page=1, output_dir="books", output_file=None):
    """
    ...
    if output_file is None:
        output_file = os.path.join(output_dir, f"output_{book_id}.txt")
...
def scrape_multiple_books(book_ids, start_page=1, output_dir="books"):
    """
    ...
    with ThreadPoolExecutor() as executor:
        ...
        for book_id in book_ids:
            executor.submit(get_web_info, book_id, start_page, output_dir)
